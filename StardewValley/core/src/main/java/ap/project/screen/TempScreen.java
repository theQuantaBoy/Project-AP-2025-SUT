...
//        Table grid = new Table(GameAssetsManager.getGameAssetsManager().getSkin());
//        grid.defaults().size(48).pad(4);  // each slot is 48×48 with 4px padding
//        for (int row = 0; row < 5; row++) {
//            for (int col = 0; col < 10; col++) {
//                ImageButton slot = new ImageButton(GameAssetsManager.getGameAssetsManager().getSkin());
//                grid.add(slot);
//            }
//            grid.row();
//        }
//        Stack stack = new Stack();
//        stack.add(inventoryWindow);
//        stack.add(skillsTable);
//        stack.add(shippingTable);
//// at any time:
